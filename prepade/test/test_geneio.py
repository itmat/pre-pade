...
class ExonIndexTest(unittest.TestCase):
    ...
    def test_exon_index(self):
        ...
        self.assertEquals(1, len(list(idx.get_exons('chr1', None, 0, 5))))
        self.assertEquals(1, len(list(idx.get_exons('chr1', None, 3, 5))))
        self.assertEquals(1, len(list(idx.get_exons('chr1', None, 3, 7))))
        self.assertEquals(2, len(list(idx.get_exons('chr1', None, 7, 12))))
        self.assertEquals(3, len(list(idx.get_exons('chr1', None, 7, 17))))
        self.assertEquals(2, len(list(idx.get_exons('chr1', None, 10, 17))))
        self.assertEquals(1, len(list(idx.get_exons('chr1', None, 28, 29))))
        self.assertEquals(0, len(list(idx.get_exons('chr1', None, 30, 34))))
